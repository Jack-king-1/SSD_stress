...
echo "====== Start time ======" | tee -a /opt/performance_test_log/total_time.log
date | tee -a /opt/performance_test_log/total_time.log
...
echo "==================== 4k_16k seq pre ===================="
fio --output=${path}/precondition/fio_4k16k_seq1_precondition.log ${path}/precondition_file/fio_seq1_precondition.cfg &
fio --output=${path}/precondition/fio_4k16k_seq2_precondition.log ${path}/precondition_file/fio_seq2_precondition.cfg &
wait
echo "==================== 4k_16k rand pre ==================="
fio --output=${path}/precondition/fio_4k16k_rand1_precondition.log ${path}/precondition_file/fio_rand1_precondition.cfg &
fio --output=${path}/precondition/fio_4k16k_rand2_precondition.log ${path}/precondition_file/fio_rand2_precondition.cfg &
wait
secure_erase	
#====================== 4k_16k_randrw_job ===========================
...
echo "====== End time ======" | tee -a /opt/performance_test_log/total_time.log
date | tee -a /opt/performance_test_log/total_time.log
